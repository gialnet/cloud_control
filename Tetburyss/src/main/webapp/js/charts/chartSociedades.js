$(document).ready(function () {
    ...
    $("#chartSociedades").bind("plothover", function (event, pos, item) {
        $("#x").text(pos.x.toFixed(2));
        $("#y").text(pos.y.toFixed(2));

        if ($("#chartSociedades").length > 0) {
            if (item) {
    ...
    $("#chartSociedades").bind("plotclick", function (event, pos, item) {
        if (item) {
