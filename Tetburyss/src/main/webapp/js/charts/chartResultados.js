$(document).ready(function () {
    ...
    $("#chartResultados").bind("plothover", function (event, pos, item) {
        $("#x").text(pos.x.toFixed(2));
        $("#y").text(pos.y.toFixed(2));

        if ($("#chartResultados").length > 0) {
            if (item) {
    ...
    $("#chartResultados").bind("plotclick", function (event, pos, item) {
        if (item) {
